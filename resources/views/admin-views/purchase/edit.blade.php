                    ...
                    <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" >
                        ...
                        <tbody id="purchase-table">
                            <tr id="addPurchase_row">
                                ...
                                <td>
                                    <input type="number" name="" class="form-control quantity" required>
                                </td>
                                <td>
                                    <input type="text" class="form-control quantity_type" readonly>
                                </td>
                                <td>
                                    <input type="number" name="" class="form-control rate" required>
                                </td>
                                <td>
...
<script>
 function addPurchaseTbl() {
            ...
            html += '<td>' + 
                        ...
                        '</select>' +
                    '</td>';
            html += '<td><input type="number" name="" class="form-control quantity" required></td>';
            html += '<td><input type="text" class="form-control quantity_type" required readonly></td>';
            html += '<td><input type="number" name="" class="form-control rate" required></td>';
