                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" type="text" name="start_date"  class="form-control" placeholder="{{ translate('Select dates') }}" value="{{$coupon['start_date']}}"
                                           >
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="expire_date" id="expire_date" class="form-control"  placeholder="{{ translate('Select dates') }}" value="{{$coupon['expire_date']}}">
                                    </div>
                                </div>
