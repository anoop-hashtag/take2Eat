...
@section('content')
    ...
    $current = \App\Model\DeliveryHistory::where(['deliveryman_id' => $order['delivery_man_id'], 'order_id' => $order['id']])->latest()->first(),
                                                    ...
                                                    @if (isset($origin))
                                                        <a class="btn btn-outline-primary" target="_blank"
                                                            title="{{ translate('Delivery Partner Last Location') }}"
                                    ...
                                    <div class="d-flex gap-3 justify-content-sm-end my-3">
                                        ...
                                        @elseif($order['order_status'] == 'canceled')
                                            <span
                                                class="badge-soft-danger px-2 rounded text-capitalize">{{ translate('cancelled') }}</span>
                                        @else
                                            <span
                                    ...
                                    <div class="d-flex gap-3 justify-content-sm-end mb-3 text-capitalize">
                                        ...
                                        : <label class="badge-soft-info px-2 rounded">
                                            <?php $order_type = $order['order_type'] == 'pos' ? 'POS' : $order['order_type']; ?>
                                            {{ str_replace('_', ' ', $order_type) }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="py-4 table-responsive">
                        <table
                            class="table-style table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                                ...
                                @foreach ($order->details as $detail)
                                    ...
                                    <tr>
                                            ...
                                            <div class="media gap-3 w-max-content gap-style">
                                                ...
                                                <div class="media-body text-dark fz-12">
                                                    ...
                                                    <div class="gap-2">
                                                        ...
                                                        @else
                                                            <div class="font-size-sm text-body">
                                                                <span class="text-dark">{{ translate('price') }} :
                                                                    {{ \App\CentralLogics\Helpers::set_symbol($value['optionPrice']) }}</span>
                                                            </div>
                                                            <?php
                                                            $amount = $amount + $value['optionPrice'];
                                                            ?>
                                                            ...
                                                            <div style="text-align: left">
                                                                ...
                                                                @if ($addon_ids)
                                                                    ...
                                                                    @foreach ($addon_ids as $key2 => $id)
                                                                        ...
                                                                        {{-- @php(array_push($addon_price, ($add_on_qty * $add_on_prices[$key2])))     --}}
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            // if (isset($variation['values']) && is_array($variation['values'])) {
                                            //     echo \App\CentralLogics\Helpers::set_symbol($totalOptionPrice);
                                            // } else {
                                        ...
                                        <td>
                                            {{-- @php($tot_discount =($totalOptionPrice * $detail->product['discount'])/ 100) --}}
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row">
                                    ...
                                    @if ($order['packing_fee'] == 0.0)
                                        <dt class="col-8">{{ translate('') }}</dt>
                                        <dd class="col-4"></dd>
                                    @else
                                        <dt class="col-8">&nbsp;&nbsp;{{ translate('Packing Fee') }}:</dt>
                                        <dd class="col-4">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ \App\CentralLogics\Helpers::set_symbol($order['packing_fee']) }}
                                        </dd>
                                    @endif
                                    <dt class="col-6">
                                        <div class="d-flex max-w220 ml-auto">
                                    ...
                                    <dd class="col-6 border-top pt-2 fz-16 font-weight-bold text-dark text-right">
                                        {{ \App\CentralLogics\Helpers::set_symbol($sub_total - $order['coupon_discount_amount'] - $order['extra_discount'] + $del_c + $order['packing_fee'] + $total_tax + $add_ons_tax_cost) }}
                                    </dd>
                                        ...
                                        @foreach ($order->order_partial_payments as $partial)
                                            <dt class="col-6">
                                                <div class="d-flex max-w220 ml-auto">
                                                    <span>
                                                        {{ translate('Paid By') }}
                                                        ({{ str_replace('_', ' ', $partial->paid_with) }})</span>
                                        ...
                                        <select name="order_status"
                                            ...
                                            @if ($order['order_type'] != 'dine_in')
                                                <option value="processing"
                                                    {{ $order['order_status'] == 'processing' || $order['order_status'] == 'cooking' ? 'selected' : '' }}>
                                            ...
                                            @if ($order['order_type'] == 'dine_in')
                                                <option value="cooking"
                                                    {{ $order['order_status'] == 'cooking' ? 'selected' : '' }}>
                                                    {{ translate('cooking') }}</option>
                                    ...
                                    <div class="" style="display: none">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap flex-xxl-nowrap">
                                            <input onchange="changeDeliveryTimeDate(this)" name="delivery_date"
                                                type="text" id="from_date" class="form-control"
                                            ...
                                            <input onchange="changeDeliveryTimeDate(this)" name="delivery_time"
                                                type="text" id="datetimepicker1" class="form-control"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media flex-wrap gap-3">
                                            ...
                                            <div class="media-body d-flex flex-column gap-1">
                                                <a target="" href="#" class="text-dark">
                                                    <span>{{ $order->delivery_man['f_name'] . ' ' . $order->delivery_man['l_name'] ?? '' }}</span>
                                                </a>
    ...
    $current = \App\Model\DeliveryHistory::where(['deliveryman_id' => $order['delivery_man_id'], 'order_id' => $order['id']])->latest()->first(),
                                            ...
                                            @if (isset($origin))
                                                <a target="_blank" class="text-dark" title="Delivery Boy Last Location"
                                                    data-toggle="tooltip" data-placement="top"
                                        ...
                                        @else
                                            <a href="javascript:" onclick="last_location_view()" class="text-dark"
                                                ...
                                                <img width="13"
                                                    src="{{ asset('public/assets/admin/img/icons/location.png') }}"
                                                    alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                {{ translate('Only available when order is out for delivery!') }}
                                            </a>
                                        @endif
                                    </div>
                                </div>
                            ...
                            @if ($order->customer)
                                <div class="media flex-wrap gap-3">
                                    ...
                                    <div class="media-body d-flex flex-column gap-1">
                                        ...
                                        <span class="text-dark">{{ $order->customer['orders_count'] }}
                                            {{ translate('Orders') }}</span>
                                        <span class="text-dark">
                                            <i class="tio-call-talking-quiet mr-2"></i>
                                        ...
                                        <span class="text-dark">
                                            ...
                                            <a class="text-dark break-all" href="">GSTIN:
                                                {{ $order->customer['gst_number'] }}</a>
                                        </span>
                                    </div>
                                </div>
                            @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fs-5" id="assignDeliveryManLabel">{{ translate('Assign_Delivery_Partner') }}
                    </h4>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deliveryInfoModal" id="deliveryInfoModal"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="mySmallModalLabel">{{ translate('Update_Delivery_Information') }}
                    </h5>
                    <button type="button" class="btn btn-xs btn-icon btn-ghost-secondary" data-dismiss="modal"
                        aria-label="Close">
                        <i class="tio-clear tio-lg"></i>
