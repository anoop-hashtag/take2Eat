                        ...
                        <div class="row gy-3 gx-2 align-items-end">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="form-group mb-0">
                                    ...
                                    <input type="text" name="from" value="{{$from}}" id="from_date"  autocomplete="off" placeholder="DD-MM-YY" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-3">
                                <div class="form-group mb-0">
                                    <label class="text-dark">{{ translate('End Date') }}</label>
                                    <input type="text" value="{{$to}}" name="to" id="to_date" autocomplete="off" placeholder="DD-MM-YY" class="form-control">
                                </div>
                            </div>
