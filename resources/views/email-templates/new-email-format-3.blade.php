                                                            ...
                                                            @foreach ($order->details as $detail)
                                                               ...
                                                               <td>
                                                                  <div class="media gap-3 w-max-content">
                                                                     <img class="img-fluid avatar avatar-lg" src="{{ asset('storage/app/public/product/') }}/{{      $detail->product?->image }}" onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'" alt="Image Description" />
