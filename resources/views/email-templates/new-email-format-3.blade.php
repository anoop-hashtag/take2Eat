                                          ...
                                          <tbody>
                                             ...
                                             <td colspan="2">
                                                <table class="w-100">
                                                   <thead class="bg-section-2">
                                                      <tr>
                                                         <th class="text-left p-1 px-3" width="40%" class="p-1 px-3" style="text-align: right;">{{ translate('Product') }}</th>
                                                         <th width="40%" class="p-1 px-3" style="text-align: right;">{{ translate('Price') }}</th>
                                                      </tr>
                                                   </thead>
                                                   <tbody>
                                                      <tr>
