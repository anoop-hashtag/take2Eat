                                ...
                                <tr>
                                    <td class="p-10">
                                        <span class="d-block text-center">
                                            @php
                                                $restaurant_logo = \App\Models\BusinessSetting::where('key', 'logo')->first()->value;
                                            @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="max-width:130px">
                                                        ...
                                                        @if ($order->delivery_address)
                                                            ...
                                                            <span class="d-block">{{ $address['address'] ?? null }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @php
                                                                                        ...
                                                                                        @if ($addon_ids)
                                                                                            <span>
                                                                                                ...
                                                                                                @foreach ($addon_ids as $key2 => $id)
                                                                                                    ...
                                                                                                    $add_on_qty=$add_on_qtys==null ? 1 : $add_on_qtys[$key2];
                                                                                                @endphp
                                                                                                    <div class="font-size-sm text-body">
