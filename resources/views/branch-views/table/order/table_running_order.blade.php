...
{{--                    <div class="card-body p-3">--}}
                        <div class="table-responsive datatable-custom" style="padding:0 10px">
                            ...
                            <div class="table-responsive datatable-custom" style="padding: 0 10px; position: relative;">
                                <div id="no-data-message" style="display: none; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
