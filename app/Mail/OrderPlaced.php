...
class OrderPlaced extends Mailable
{
    ...
    public function build()
    {
        ...
        $data=EmailTemplate::with('')->where('type','user')->where('email_type', 'new_order')->first();
       ...
       return  $template_data =  $this->subject(translate('Order_Place_Mail'))->view('email-templates.new-email-format-'.$template, ['company_name'=>$company_name,'data'=>$data,'title'=>$title,'body'=>$body,'footer_text'=>$footer_text,'copyright_text'=>$copyright_text,'order'=>$order,'url'=>$url]);
