...
class OrderLogic
{
    ...
    // Convert the created_at timestamp to the local time zone
        ...
        $response['created_at'] = Carbon::parse($response['created_at'])->setTimezone($localTimezone)->format('Y-m-d H:i:s');
